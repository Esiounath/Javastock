...
public class Javastock extends JFrame {
      ...
      Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        public void CreateReservation(JPanel panel) {
            ...
            String[] quantite = Requests("SELECT quantite_disponible()","quantite_disponible()");
            JComboBox<String> date = new JComboBox<>(creerListeDeroulanteDate(10));
            JComboBox<String> id_article = new JComboBox<>(Requests("SELECT id_article,libelle FROM reservations","id_article"));

           JLabel[] Label = {new JLabel("Date:"),new JLabel("Coureur:"),new JLabel("Type d'épreuve:"),new JLabel("Libelle + Id Article")};
